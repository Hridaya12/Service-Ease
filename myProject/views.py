    ...
    if request.method == 'POST':
        ...
        try:
            ...
            send_mail(
                subject,
                plain_message,
                'serviceease6@gmail.com',  # Replace with your sender email
                [user.email],
...
def contact_form(request):
    if request.method == 'POST':
        ...
        service_subject = f'New contact form submission from {name}'
        service_html_message = render_to_string('contact_email_service.html', {'name': name, 'phone_number': phone_number, 'email': email, 'message': message})
        service_plain_text_message = strip_tags(service_html_message)
        service_from_email = 'serviceease6@gmail.com'
        service_to_email = ['serviceease6@gmail.com']
        send_mail(service_subject, service_plain_text_message, service_from_email, service_to_email, html_message=service_html_message, fail_silently=False)
