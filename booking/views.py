...
def submit_staff_data(request):
    if request.method == 'POST':
        ...
        try:
            ...
            send_mail(user_subject, strip_tags(user_message), 'serviceease6@gmail.com', [user_email], html_message=user_message)
            ...
            send_mail(staff_subject, strip_tags(staff_message), 'serviceease6@gmail.com', [staff_email], html_message=staff_message)
